...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,6695-6710,2053,2083,2087,2096,8443,%GameFilter% --wf-udp=443,3074-3080,19294-19344,50000-50100,%GameFilter% ^
...
--filter-udp=3074-3080 --dpi-desync=fake --dpi-desync-autottl=2 --dpi-desync-repeats=10 --dpi-desync-any-protocol=1 --dpi-desync-fake-unknown-udp="%BIN%quic_initial_www_google_com.bin" --dpi-desync-cutoff=n2
